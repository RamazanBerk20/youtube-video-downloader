...
_T: dict[str, dict[str, str]] = {
    "en": {
        ...
        "auto_update.off": "disabled",
        "log.auto_update_toggled": "Auto-update at startup: {state}.",
        "menu.cut": "Cut",
        "menu.copy": "Copy",
        "menu.paste": "Paste",
        "menu.select_all": "Select all",
        "check.reencode_h264": "Re-encode to H.264 + AAC (slow, max compatibility)",
        ...
        "banner.js_runtime_missing": "A JavaScript runtime is required to fetch video formats from YouTube (anti-bot challenge solver). Install Deno?",
    ...
    "tr": {
        ...
        "auto_update.on": "etkin",
        "auto_update.off": "devre dışı",
        "log.auto_update_toggled": "Başlangıçta otomatik güncelleme: {state}.",
        "menu.cut": "Kes",
        "menu.copy": "Kopyala",
        "menu.paste": "Yapıştır",
        "menu.select_all": "Tümünü seç",
        "check.reencode_h264": "H.264 + AAC'e yeniden kodla (yavaş, en geniş uyumluluk)",
        ...
        "banner.js_runtime_missing": "YouTube'dan video formatlarını almak için bir JavaScript çalışma zamanı gerekli (bot doğrulama çözücüsü). Deno kurulsun mu?",
    ...
    "es": {
        ...
        "auto_update.on": "activada",
        "auto_update.off": "desactivada",
        "log.auto_update_toggled": "Auto-actualización al iniciar: {state}.",
        "menu.cut": "Cortar",
        "menu.copy": "Copiar",
        "menu.paste": "Pegar",
        "menu.select_all": "Seleccionar todo",
        "check.reencode_h264": "Recodificar a H.264 + AAC (lento, máxima compatibilidad)",
        ...
        "banner.js_runtime_missing": "Se requiere un entorno de ejecución JavaScript para obtener los formatos de vídeo de YouTube (solucionador anti-bot). ¿Instalar Deno?",
    ...
    "fr": {
        ...
        "auto_update.on": "activée",
        "auto_update.off": "désactivée",
        "log.auto_update_toggled": "Mise à jour auto au démarrage : {state}.",
        "menu.cut": "Couper",
        "menu.copy": "Copier",
        "menu.paste": "Coller",
        "menu.select_all": "Tout sélectionner",
        "check.reencode_h264": "Réencoder en H.264 + AAC (lent, compatibilité maximale)",
        ...
        "banner.js_runtime_missing": "Un environnement d'exécution JavaScript est requis pour récupérer les formats vidéo de YouTube (solveur anti-bot). Installer Deno ?",
    ...
    "de": {
        ...
        "auto_update.on": "aktiviert",
        "auto_update.off": "deaktiviert",
        "log.auto_update_toggled": "Auto-Update beim Start: {state}.",
        "menu.cut": "Ausschneiden",
        "menu.copy": "Kopieren",
        "menu.paste": "Einfügen",
        "menu.select_all": "Alles markieren",
        "check.reencode_h264": "In H.264 + AAC neu kodieren (langsam, max. Kompatibilität)",
        ...
        "banner.js_runtime_missing": "Eine JavaScript-Laufzeit ist erforderlich, um Videoformate von YouTube abzurufen (Anti-Bot-Challenge-Löser). Deno installieren?",
    ...
    "ru": {
        ...
        "auto_update.on": "включено",
        "auto_update.off": "выключено",
        "log.auto_update_toggled": "Автообновление при запуске: {state}.",
        "menu.cut": "Вырезать",
        "menu.copy": "Копировать",
        "menu.paste": "Вставить",
        "menu.select_all": "Выделить всё",
        "check.reencode_h264": "Перекодировать в H.264 + AAC (медленно, макс. совместимость)",
        ...
        "banner.js_runtime_missing": "Для получения форматов видео с YouTube требуется среда выполнения JavaScript (решатель анти-бот проверки). Установить Deno?",
    ...
    "ar": {
        ...
        "auto_update.on": "مُفعّل",
        "auto_update.off": "مُعطّل",
        "log.auto_update_toggled": "التحديث التلقائي عند التشغيل: {state}.",
        "menu.cut": "قص",
        "menu.copy": "نسخ",
        "menu.paste": "لصق",
        "menu.select_all": "تحديد الكل",
        "check.reencode_h264": "إعادة الترميز إلى H.264 + AAC (بطيء، أقصى توافق)",
        ...
        "banner.js_runtime_missing": "يلزم تشغيل JavaScript لجلب صيغ الفيديو من يوتيوب (حل تحدي مكافحة البوت). هل تريد تثبيت Deno؟",
    ...
    "zh": {
        ...
        "auto_update.on": "已启用",
        "auto_update.off": "已禁用",
        "log.auto_update_toggled": "启动时自动更新:{state}。",
        "menu.cut": "剪切",
        "menu.copy": "复制",
        "menu.paste": "粘贴",
        "menu.select_all": "全选",
        "check.reencode_h264": "重新编码为 H.264 + AAC(较慢,最广兼容)",
        ...
        "banner.js_runtime_missing": "从 YouTube 获取视频格式需要 JavaScript 运行时(用于解决反机器人验证)。安装 Deno?",
    ...
    "ja": {
        ...
        "auto_update.on": "有効",
        "auto_update.off": "無効",
        "log.auto_update_toggled": "起動時の自動更新: {state}。",
        "menu.cut": "切り取り",
        "menu.copy": "コピー",
        "menu.paste": "貼り付け",
        "menu.select_all": "すべて選択",
        "check.reencode_h264": "H.264 + AAC に再エンコード(遅い、最大互換)",
        ...
        "banner.js_runtime_missing": "YouTube から動画フォーマットを取得するには JavaScript ランタイムが必要です(ボット対策チャレンジソルバー)。Deno をインストールしますか?",
